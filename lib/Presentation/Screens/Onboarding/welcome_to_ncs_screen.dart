...
/*
Title: WelcomeToNCSScreen used thorough App
Purpose:WelcomeToNCSScreen used thorough App
Created On: 12/06/2024
Edited On:12/06/2024
*/


class WelcomeToNCSScreen extends StatefulWidget {
  const WelcomeToNCSScreen({super.key});

  @override
  State<WelcomeToNCSScreen> createState() => _WelcomeToNCSState();
}

class _WelcomeToNCSState extends State<WelcomeToNCSScreen> {
  int _currentPage = 0;
  @override
  void initState() {
    super.initState();
