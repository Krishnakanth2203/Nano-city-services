...
import 'package:nano_city_services/AppUtils/app_font_size.dart';
import 'package:nano_city_services/AppUtils/app_font_weight.dart';
...
class AppTextStyle {
  ...
  static TextStyle welcomeSubStyle = const TextStyle(
    fontWeight: FontWeight.bold,
    fontSize: 16,
    color: Colors.white,
  );
